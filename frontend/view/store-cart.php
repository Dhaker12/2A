                        ...
                        <tr>
                            ...
                            <td class="nk-product-cart-title">
                                ...
                                <h2 class="nk-post-title h4">
                                    <a href="store-product.html" ><?PHP echo $row['nom'];  ?></a>
                            ...
                            <td class="nk-product-cart-price">
                                ...
                                <strong><?PHP echo $row['prix']; ?></strong>
                            </td>
                            <td class="nk-product-cart-quantity">
                                <h5 class="h6">Quantity:</h5>
                                <div class="nk-gap-1"></div>
                                <div class="nk-form">
                                <input type="number" name="quantite" class="form-control" value="<?PHP echo $row['quantite']; ?>" min="1" max="21">
                                </div>
                            </td>

...
if ((isset($_GET['email'])) and (isset($_GET['nom'])) and (isset($_GET['prenom'])) and (isset($_GET['type']))  and (isset($_GET['description'])))
{
$email=$_GET['email'];
$nom=$_GET['nom'];
$prenom=$_GET['prenom'];
...
if ((!empty($_GET['email'])) and (!empty($_GET['nom'])) and (!empty($_GET['prenom'])) and (!empty($_GET['type']))   and (!empty($_GET['description'])) )
{
...
$reclamation1=new reclamation(new \DateTime(),$numero,$description,"Non traite",$nom,$prenom,$type,$email);

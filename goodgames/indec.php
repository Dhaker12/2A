                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <div class="nk-post-by">
                                <img src="assets/images/avatar-3.jpg" alt="Wolfenstein" class="rounded-circle" width="35"> by <a href="https://nkdev.info">Wolfenstein</a> in Jul 23, 2018
                            </div>
                            <div class="nk-gap"></div>
                            <div class="nk-post-text">
                                <p>Just then her head struck against the roof of the hall: in fact she was now more than nine feet high, and she at once took up the little golden key and hurried off to the garden door...</p>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="nk-blog-post">
                            ...
                            <h2 class="nk-post-title h4"><a href="blog-article.html">At first, for some time, I was not able to answer</a></h2>
                            <div class="nk-post-by">
                                <img src="assets/images/avatar-3.jpg" alt="Wolfenstein" class="rounded-circle" width="35"> by <a href="https://nkdev.info">Wolfenstein</a> in Jul 3, 2018
                            </div>
                            <div class="nk-gap"></div>
                            <div class="nk-post-text">
                                <p>This little wandering journey, without settled place of abode, had been so unpleasant to me, that my own house, as I called it to myself, was a perfect settlement to me compared to that...</p>
                ...
                <form action="#" class="nk-form text-white">
                    <div class="row vertical-gap">
                        <div class="col-md-6">
                            ...
                            <div class="nk-gap"></div>
                            <input type="email" value="" name="login" class=" form-control" placeholder="Email">

                            <div class="nk-gap"></div>
                            <input type="password" value="" name="pwd" class="required form-control" placeholder="Password">
                            <br>
                            <input type="submit" class="nk-btn nk-btn-rounded nk-btn-color-white nk-btn-block" name="button" id="button" value="sign in" />
                        </div>
                        <div class="col-md-6">
                            Or social account:
                    ...
                    <div class="row vertical-gap">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mnt-5">
                                <small><a href="store-checkout.html">Not a member? Sign up</a></small>
                            </div>
                        </div>
                    </div>
                </form>

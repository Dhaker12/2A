    ...
    <div class="row vertical-gap">
        <div class="col-lg-8">
            ...
            <div class="nk-blog-post nk-blog-post-single">
                <!-- START: Post Text -->
                <?PHP
include "C:/wamp64/www/goodgames/dist/entities/Article.php";
include "C:/wamp64/www/goodgames/dist/core/ArtcileC.php";
if (isset($_GET['name'])){
    $ArticleC=new ArticleC();
    $result=$ArticleC->recupererarticle($_GET['name']);
...
?> 
                <div class="nk-post-text mt-0">
                    ...
                    <div class="nk-gap-1"></div>
                    <h1 class="nk-post-title h4"><?PHP echo $row['name']; ?></h1>
                    <div class="nk-post-by">
                        <img src="assets/images/avatar-2.jpg" alt="Witch Murder" class="rounded-circle" width="35"> by <a href="https://nkdev.info"><?PHP echo $row['avatar']; ?></a> in <?PHP echo $row['date']; ?>
                ...
                <!-- START: Comments -->
                <div id="comments"></div>
                <h3 class="nk-decorated-h-2"><span><span class="text-main-1"></span> Comments</span></h3>
                <div class="nk-gap"></div>
                <div class="nk-comments">
                    ...
                    <div class="nk-comment">
                        ...
                        $liste=$Article1C->showreplys();
                                            foreach($liste as $row){
                                        ?>
                        <div class="nk-comment-meta">
                             by <a href="https://nkdev.info"><?PHP echo $row['name']; ?></a> in <?PHP echo $row['date']; ?>
                ...
                <div class="nk-gap"></div>
                <div class="nk-reply">
                    <form method="POST" action="addreply.php" class="nk-form">
                        ...
                        <input  class="nk-btn nk-btn-rounded nk-btn-color-main-1" type="submit" value="add a reply"/>

<?PHP
include "C:/wamp64/www/goodgames/dist/core/gameC.php";
session_start();
$client=$_SESSION["l"]; 
$game1C=new gameC();
$list=$game1C->showgames();
$liste=$game1C->showfavoris($client);
    ...
    <?PHP
                ...
                <tbody>
                    ...
                    <img src="data:image/jpeg;base64,'.base64_encode($row['image'] ).'" height="200" width="200" class="img-thumnail" />';?>  
                            ...
                            <td class="nk-product-cart-title">
                                <h5 class="h6">Game's Name:</h5>
                                <div class="nk-gap-1"></div>

                                <h2 class="nk-post-title h4">
                                    <a href="store-product.html"><?PHP echo $row['name']; ?></a>
                                </h2>
                            </td>
                            ...
                            <td class="nk-product-cart-price">
                                <h5 class="h6">Our Rating:</h5>
                                <div class="nk-gap-1"></div>

                                <strong><?PHP echo $row['rating']; ?> / 10</strong>
                            </td>
                            <td class="nk-product-cart-price">
                                <div class="nk-gap-1"></div>
<br> <br>
                                <strong><a href="addfavori.php?name=<?PHP echo $row['name']; ?>" class="nk-btn nk-btn-rounded nk-btn-color-main-1">Favori</a></strong>
                            </td> 
            ...
            <div class="col-md-6">
                <div class="nk-widget">
                    ...
                    <div class="nk-widget-content">
                        <form action="php/ajax-contact-form.php" class="nk-form nk-form-ajax" method="post" action="mail.php">
                            ...
                            <textarea class="form-control required" name="sujet" rows="5" placeholder="Message *"></textarea>
                            <div class="nk-gap-1"></div>

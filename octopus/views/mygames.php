...
<form method="post" action="modifygame.php">
								...
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">Games's name  <span class="required">*</span></label>
											<div class="col-sm-9">
											<input type="text" name="nam" class="form-control" title="Plase enter the refrence." placeholder="the refrence is .." required="">
											</div>
										</div>
										<div class="form-group">

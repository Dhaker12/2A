			...
			<header class="clearfix">
				<div class="row">
					...
					<div class="col-sm-6 text-right mt-md mb-md">
						...
						<div class="ib">
							<img src="assets/images/news.jpg" alt="OKLER Themes" style="width:250px;height:100px;" />
						</div>
					</div>
				</div>
			</header>
											...
											<div class="widget-twitter-profile">
												...
												<div class="profile-info">
													...
													<div class="profile-account">
														<h3 class="name text-semibold"><?PHP echo $row['avatar']; ?></h3>
														<a href="#" class="account"><?PHP echo $row['type']; ?></a>

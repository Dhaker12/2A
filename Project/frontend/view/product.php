...
<div class="container">
    <ul class="nk-breadcrumbs">
        ...
        <li><a href="affproduit.php">Store</a></li>
                            ...
                            <div class="nk-reply">
                                <form action="#" class="nk-form">
                                    ...
                                    <div class="row vertical-gap sm-gap">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control required" name="country" placeholder="my country is *">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="number" class="form-control required" name="week" placeholder="number of week *">
                                        </div>
                                    </div>
                                    <div class="nk-gap-1"></div>
                            ...
                            <div class="row vertical-gap sm-gap">
                                ...
                                <div class="col-md-6">
                                   <select class="form-control">
                                     ...
                                     <option value="ps4">About the service Quality</option>
                                     <option value="xbox">Problem of the product</option>
                                     <option value="pc">Switch Product</option>
                                    </select>
                                </div>

<?php
session_start();
include_once "../core/wishC.php";
include_once "../core/produitCore.php";
$wishc=new WishC();
$list=$wishc->afficherwish();
?>
<!DOCTYPE html>
<!--
                    ...
                    <div class="nk-cart-dropdown">
                        ...
                        <div class="nk-widget-post">
                            ...
                            <h3 class="nk-post-title">
                                ...
                                <a >My account</a><br>
                                <a >email <?php echo $_SESSION['login']; ?></a><br>
...
<div class="container">
    <ul class="nk-breadcrumbs">
        ...
        <li><a href="store.html">Wish list</a></li>
                ...
                <?php 
                                        foreach ($list as $row) {
                                           ...
                                           {$produit=new ProduitCore();
                                            $resultat=$produit->recupererproduit($row['Reference']);
                                        foreach ($resultat as $row) {
                                            
                                        ?>
               
                        <?php
                echo'<a class="nk-product-image" href="product.php">
                    <img style="width:250px;heigth:345px;"src="data:image/jpeg;base64,'.base64_encode(stripslashes($row['photo'])).'">
                </a>;'
                ?>
                        <div class="nk-product-cont">
                            
                            <h3 class="nk-product-title h5"><a href="store-product.html"><label  ><?php  echo $row['reference']; ?></label></a></h3>
                            <div class="nk-gap-1"></div>
                            <?php echo $row['description'] ?>
                            <div class="nk-gap-2"></div>
                            <div class="nk-product-price"><?php echo $row['prix']; ?> dt</div>
                            <div class="nk-gap-1"></div>
                            <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Add to Cart</a>
                            <div class="actions">
                            <form method="POST" action="supprimerwish.php">
                                                <input class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1" type="submit" name="supprimer" value="remove">
                                                <input type="hidden" value="<?PHP echo $row['reference']; ?>" name="Nom">
                                                <input type="hidden" value="<?PHP echo $_SESSION['login']; ?>" name="email">
                                                </form>
                                                </div>
                            <!--<a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">remove</a>-->

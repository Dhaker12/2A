...
{
if (isset($_POST["ref"]) and isset($_POST["new"]) and ( $_POST["modwith"]=="Reference" or $_POST["modwith"]=="Prix" or $_POST["modwith"]=="Cathegory" or $_POST["modwith"]=="Nom" or $_POST["modwith"]=="Photo")  ) {

							...
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="modifierclient.html">modify a client</a>
											</li>
											<li>
												<a href="listec.php">list of clients</a>
											</li>
					...
					<!-- start: page -->
						<section class="panel">
							...
							<div class="panel-body">
								...
								<div><button type="button" ><a href="imprimerclient.php">IMPRIMER</a></button>
									...
									<tbody>
										...
										<tr class="gradeX">
											...
											<td class="actions">
												...
												<input type="submit" name="supprimer" value="supprimer" onclick="return(confirm('are you sure you want to delete this client?'));" >

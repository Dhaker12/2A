...
$dataPoints = array( 
    array("label"=>"Conter Strike", "y"=>$cs),
    array("label"=>"Dota 2", "y"=>$dota),
    array("label"=>"League of legends", "y"=>$lol),
									...
									<div class="col-md-4">
										<section class="panel panel-danger">
											<header class="panel-heading">
												...
												<h2 class="panel-title"><?PHP echo $row['nom']; ?></h2>
												<p class="panel-subtitle"><?PHP echo $row['game']; ?></p>
											</header>

											<div class="panel-body">
												<div class="thumb-info mb-md">
													<a href="statsp.php?nom=<?PHP echo $row['nom']; ?>">
										<?PHP echo'

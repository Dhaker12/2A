						...
						<div class="col-md-12">
							<section class="panel-group mb-xlg">
								...
								<div class="widget-twitter-profile">
									...
									<!-- Modal Icon -->
									<a class="mb-xs mt-xs mr-xs modal-basic btn btn-danger" href="#modalIcon">Icon</a>
									<a class="mb-xs mt-xs mr-xs modal-basic btn btn-success" href="#modalCenterIcon">Center Icon</a>
											...
											<footer class="panel-footer">
												<div class="row">
													<div class="col-md-12 text-right">
														<button type="submit" class="btn btn-primary modal-confirm" name="delete" value="<?PHP echo $row['nom']; ?>">Confirm</button>
